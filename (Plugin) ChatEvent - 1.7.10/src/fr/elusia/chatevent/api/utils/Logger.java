...
public class Logger {
	...
	public static void log(Level level, ChatEventPlugin plugin, String message) {
		log(level, plugin, message, true);
	}

	public static void log(Level level, ChatEventPlugin plugin, String message, boolean color) {
